...
namespace NavigatorAttractions.WebAPI.Controllers
{
    ...
    public class AttractionController : ControllerBase
    {
        ...
        //public async Task<IActionResult> GetList([FromQuery] AttractionRequestModel query, int limit, int page)
        //{
        ...
        //    //// Location Filter
        //    //GeoWithin location = FilterLocation(query);
        ...
        //    if (query.Display != null)
        //    {
        //        if (string.Equals(query.Display, "grid", StringComparison.OrdinalIgnoreCase))
        //        {
        //            query.PhotoSize = "m";
        //            query.FieldsList = "id,title,catalog,featureKey,hasPhotos,photo";
        //        }
        //        else if (string.Equals(query.Display, "list", StringComparison.OrdinalIgnoreCase))
        //        {
        //            query.PhotoSize = "t";
